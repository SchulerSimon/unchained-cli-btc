...
# network params
# used by the blockcypher api to access the correct Network
coin_symbol = 'bcy'

# used to generate an address. Take a look at
...
# minimum difficulty for a proof to be accepted (bool:accepted = blockhash
# < target)
difficulty_network_target = 0x0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff

# list of addresses that are accepted as donation addresses
# the current address is just choosen randomly, because we are in a testnet
donation_addresses = ['C2WJ48xWprnvUopzHPu2KyDA1eEJvwWTtG']

# minimum amount of btc to be donated in order for the proof to be
# accepted (in satoshi)
value_network_target = 1000

# separators for strings. Used for serialisation
sep1 = ','

# unchained deploy target folder
target_folder = '/unchained-btc/'
...
error_no_multisig = 'Please use a transaction with only one input, that is not signed by a multisig address'
